...
نوع العقار
    ...
    <div class="text2{{ $errors->has('bu_plcae') ? ' has-error' : '' }}">

        <div class="col-md-10">


            {!! Form::select("bu_plcae" ,bu_place() ,  null , ['class' => 'form-control select2']) !!}

            @if ($errors->has('bu_plcae'))
                <span class="help-block">
                    <strong>{{ $errors->first('bu_plcae') }}</strong>
                </span>
            @endif
        </div>
    ...
    <div class="text2{{ $errors->has('bu_small_dis') ? ' has-error' : '' }}">
        ...
        <div class="col-md-10">
            ...
            <div class="alert alert-warning">
                لا يمكن ادخال اكثر من ١٦٠ حرف علي حسب معاير جوجل
