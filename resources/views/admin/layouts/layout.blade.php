                   ...
                   <ul class="dropdown-menu">
                     ...
                     <li>
                       ...
                       <ul class="menu">
                         ...
                         @foreach(getNotActiveBu() as $buWatting)
                         <li>

                             <a href="{{url('/adminpanel/change_status/'.$buWatting->id.'/1')}}" class="pull-left">
                               <span >
                                   تفعيل العقار
                               </span>
                            </a>
                             <a href="{{ url('/adminpanel/bu/'.$buWatting->id.'/edit') }}" class="pull-right">
                                   <span >
                                        {{ $buWatting->bu_name}}
                                   </span>
                              </a>
                 ...
                 <li class="dropdown tasks-menu">
                   ...
                   <ul class="dropdown-menu">
                     ...
                     <li>
                       <!-- inner menu: contains the actual data -->
                       <ul class="menu">
                           @foreach(unreadMessage() as $keymessages => $valueMesssage)
                         <li><!-- Task item -->
                           <a href="{{ url('/adminpanel/contact/'.$valueMesssage->id.'/edit') }}">
                             <h3>
                               {{ $valueMesssage->contact_name }}
                               <small class="pull-right">{{ $valueMesssage->created_at }}</small>
                             </h3>
                           </a>
                         </li><!-- end task item -->
