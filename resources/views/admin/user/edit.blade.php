    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class=""><a href="#activity" data-toggle="tab" aria-expanded="true"> عقارات غير مفعلة   </a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane" id="activity">
                    ...
                    @foreach($buwating as $watting)

                        <tr>
                            <td><a href="{{ url('/adminpanel/bu/'.$watting->id.'/edit') }}">{{ $watting->bu_name }}</a></td>
                            <td> {{ $watting->created_at }} </td>

                            <td>
                                {{ bu_type()[$watting->bu_type]}}
                            </td>
                            <td>
                                {{ $watting->bu_price }}
                            </td>
                            <td>
                                {{ bu_place()[$watting->bu_plcae] }}
                            </td>
                            <td>
                                {{ $watting->bu_square }}
                            </td>
                            <td>
                                {{ bu_rent()[$watting->bu_rent] }}
                            </td>
                            <td>
                                <a href="{{url('/adminpanel/change_status/'.$watting->id.'/1')}}"> تفعيل العقار </a>
                            </td>
                        </tr>
                    ...
                    @endforeach
                        ...
                        <div class="text-center">
                            {{ $buwating->appends(Request::except('page'))->render() }}
                        </div>
                ...
                <div class="tab-pane active" id="timeline">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($buenable as $watting)
                                ...
                                <td>
                                    <a href="{{url('/adminpanel/change_status/'.$watting->id.'/0')}}"> الغاء التفعيل </a>
                                </td>
                            </tr>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">
                                تغير كلمة المرور الخاصة بالعضو
                                {{ $user->name }}
                            </h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
