...
المكان
                    ...
                    <div class="pull-left">
                        @if($b->bu_status == 0)
                            <span class="btn btn-danger btm-sm" role="button">  في انظار التفعيل  <span class="fa fa-arrow-circle-o-right" style="color:#FFFFFF"></span></span></div>
                            <a  href="{{ url('/user/edit/bullding/'.$b->id) }}" class="btn btn-warning btm-sm" > تعديل العقار </a>
                        @else
