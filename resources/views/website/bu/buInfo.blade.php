...
السعر
                    ...
                    <a href="{{ url('/search?bu_square='.$buInfo->bu_square) }}"  class="btn btn-default">
                     ...
                     <a href="{{ url('/search?bu_plcae='.$buInfo->bu_plcae) }}"  class="btn btn-default">
المنطقة
                        :
                         {{ bu_place()[$buInfo->bu_plcae] }}
                    </a>
...
نوع العقار
                        ...
                        <div class="pull-left">
                            ...
                            <a href="https://api.addthis.com/oexchange/0.8/forward/facebook/offer?url={{ url('/SingleBullding/'.$buInfo->id) }}&pubid=ra-54226aed398abab9&ct=1&title={{ $buInfo->bu_name }}|{{ getSetting() }}&pco=tbxnj-1.0" target="_blank"><img src="https://cache.addthiscdn.com/icons/v2/thumbs/32x32/facebook.png" border="0" alt="Facebook"/></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/twitter/offer?url={{ url('/SingleBullding/'.$buInfo->id) }}&pubid=ra-54226aed398abab9&ct=1&title={{ $buInfo->bu_name }}|{{ getSetting() }}&pco=tbxnj-1.0" target="_blank"><img src="https://cache.addthiscdn.com/icons/v2/thumbs/32x32/twitter.png" border="0" alt="Twitter"/></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/google_plusone_share/offer?url={{ url('/SingleBullding/'.$buInfo->id) }}&pubid=ra-54226aed398abab9&ct=1&title={{ $buInfo->bu_name }}|{{ getSetting() }}&pco=tbxnj-1.0" target="_blank"><img src="https://cache.addthiscdn.com/icons/v2/thumbs/32x32/google_plusone_share.png" border="0" alt="Google+"/></a>
                        </div>
